            ...
            <div className="modelViewer">
                <Canvas
                    ...
                    <Suspense fallback={null}>
                        <Serve 
                            binDecalUrl={this.state.binDecalUrl}
                            lidDecalUrl={this.state.lidDecalUrl}
                            frontDecalUrl={this.state.frontDecalUrl}
                            rearTopDecalUrl={this.state.rearTopDecalUrl}
                            rearBottomDecalUrl={this.state.rearBottomDecalUrl}
                            binColor={this.state.binColor}
                            lidColor={this.state.lidColor} />
                    </Suspense>
