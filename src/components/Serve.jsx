...
import { sRGBEncoding, TextureLoader, convertSRGBToLinear, FrontSide } from "three";
...
export default function Serve(props) {
  ...
  return (
    <group 
      ...
      <group position={[0, 0.26, 0]}>
        <group position={[0.16, 0, 0]}>
          <group position={[0.02, -0.11, 0.23]}>
            <mesh material={materials.mat_aluminum} material-side={FrontSide} material-aoMapIntensity={1.5} material-color={0xe8c6e1} material-roughnessMap={materials.tex_cloud_ref.map} geometry={nodes.cap_fl.geometry} />
        ...
        {/* <mesh material={materials.mat_front_decal} material-side={FrontSide} geometry={nodes.front_decal.geometry} position={[0, -0.26, 0]} />
        <mesh material={materials.mat_rear_bottom_decal} material-side={FrontSide} geometry={nodes.rear_bottom_decal.geometry} position={[0, -0.26, 0]} />
        <mesh material={materials.mat_rear_top_decal} material-side={FrontSide} geometry={nodes.rear_top_decal.geometry} position={[0, -0.26, 0]} /> */}
      ...
      <mesh material={materials.mat_floor} material-side={FrontSide} material-color={0x000000} material-alphaMap={materials.tex_floor_ref.map} geometry={nodes.floor.geometry} />
    </group>
  )
}
