...
import { sRGBEncoding, TextureLoader, convertSRGBToLinear, FrontSide, MeshBasicMaterial, Math } from "three";
...
export default function Serve(props) {
  ...
  return (
    <group 
      ...
      <mesh 
        // onPointerOver={(e) => {e.stopPropagation(); setRotate(true);}}
        // onPointerOut={(e) => {e.stopPropagation(); setRotate(false);}}
        // onClick={(e) => {e.stopPropagation(); setPose( pose + Math.degToRad(90) ); }}
        // onClick={(e) => {e.stopPropagation(); toggleRotateServe(); }}
